    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        vmore.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(DurationActivity.this,DetailsActivity.class);
        ...
        tripObjective.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(DurationActivity.this,ObjectivesActivity.class);
                startActivity(intent);
            }
        });
        ...
        tripDuration.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(DurationActivity.this,DurationActivity.class);
                startActivity(intent);
            }
        });
        ...
        tripTransport.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(DurationActivity.this,TransportationActivity.class);
                startActivity(intent);
            }
        });
        ...
        tripBudget.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(DurationActivity.this,BudgetActivity.class);
                startActivity(intent);
            }
        });
        ...
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(DurationActivity.this,HomeActivity.class);
                startActivity(intent);
            }
        });
        ...
        readRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.hasChildren()){
                    ...
                    txt2=dataSnapshot.child("duration").getValue().toString();

                    Integer value = Integer.parseInt(txt2);
